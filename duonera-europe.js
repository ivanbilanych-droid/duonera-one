...
const cityDefaults={cs:'Praha',de:'Berlin',pl:'Warszawa',sk:'Bratislava',it:'Roma',en:'Prague'};
const countryLocales={CZ:'cs',DE:'de',PL:'pl',SK:'sk',AT:'de',CH:'de',IT:'it'};
const copy={
  ...
  it:{eyebrow:'INCONTRI PRIVATI',titleOne:'Un incontro non inizia su uno schermo.',titleTwo:'Inizia da una persona.',lead:'DUONERA seleziona poche persone vicino a te che desiderano la stessa cosa: una relazione seria e un incontro reale.',radius:'Distanza',preparing:'SELEZIONE PRIVATA',people:'persone compatibili',hidden:'Il tuo profilo non è mai pubblico',cta:'Avvia la mia selezione',micro:'Gratuito · discreto · 1 minuto',mutual:'SCELTA RECIPROCA',meeting:'INCONTRO REALE',entry:'INIZIAMO VICINO A TE',question:'Chi vorresti incontrare?',iAm:'Sono',looking:'Cerco',woman:'Donna',man:'Uomo',womanAcc:'Una donna',manAcc:'Un uomo',age:'Età',city:'Città',continue:'Continua',back:'Indietro',email:'E-mail',consent:'Acconsento al trattamento dei dati per la registrazione e la selezione privata DUONERA.',privacyLink:'Privacy',submit:'Crea il profilo privato',privacy:'I tuoi dati non sono pubblici.',sending:'Salvataggio sicuro…',error:'Non è stato possibile salvare la registrazione. Controlla la connessione e riprova.'},
...
Object.assign(copy.it,{login:'Accedi',cookieText:'Aiutaci a misurare l’efficacia di DUONERA. La misurazione pubblicitaria inizierà solo con il tuo consenso.',cookieMore:'Maggiori informazioni',cookieReject:'Solo necessari',cookieAccept:'Consenti misurazione'});
...
if('serviceWorker'in navigator){window.addEventListener('load',()=>navigator.serviceWorker.register('/service-worker.js?v=35').catch(()=>{}))}
