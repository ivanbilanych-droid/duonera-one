...
const conversionTranslations = {
  cs: {
    registerFree:'Začít zdarma', heroKicker:'LUXURY SEZNAMOVÁNÍ PRO VÁŽNÝ VZTAH V EVROPĚ',
    heroConversionTitle:'Skuteční lidé. Vzájemná volba. Opravdové setkání.',
    heroConversionLead:'DUONERA je soukromý mobilní klub. Profily zveřejňujeme pouze se souhlasem a po kontrole. Vyberete si člověka, ne nekonečný katalog.',
    ...
    footerConversionTag:'Skuteční lidé. Vzájemná volba. Opravdové setkání.',
    productLabel:'DUONERA V TELEFONU', productTitle:'Stejně jednoduché jako swipe. Mnohem osobnější.', productText:'Po registraci uvidíte pouze skutečné schválené profily. Sympatie se otevře až při vzájemné volbě. Žádné falešné fotografie na úvodní stránce.',
  ...
  en: {
    registerFree:'Start for free', heroKicker:'LUXURY DATING FOR A SERIOUS RELATIONSHIP IN EUROPE',
    heroConversionTitle:'Real people. Mutual choice. A real meeting.',
    heroConversionLead:'DUONERA is a private mobile club. Profiles appear only with consent and after review. Choose a person, not an endless catalogue.',
    ...
    footerConversionTag:'Real people. Mutual choice. A real meeting.',
    productLabel:'DUONERA ON YOUR PHONE', productTitle:'As simple as a swipe. Far more personal.', productText:'After registration you see only real, approved profiles. Interest opens only when the choice is mutual. No fake photos on the landing page.',
  ...
  de: {
    registerFree:'Kostenlos starten', heroKicker:'LUXURY PARTNERSUCHE FÜR EINE ERNSTE BEZIEHUNG IN EUROPA',
    heroConversionTitle:'Echte Menschen. Gemeinsame Wahl. Ein echtes Treffen.',
    heroConversionLead:'DUONERA ist ein privater mobiler Club. Profile erscheinen nur mit Zustimmung und nach Prüfung. Sie wählen einen Menschen, keinen endlosen Katalog.',
    ...
    footerConversionTag:'Echte Menschen. Gemeinsame Wahl. Ein echtes Treffen.',
    productLabel:'DUONERA AUF DEM HANDY', productTitle:'So einfach wie ein Swipe. Viel persönlicher.', productText:'Nach der Registrierung sehen Sie nur echte, geprüfte Profile. Interesse öffnet sich erst bei gegenseitiger Wahl. Keine falschen Fotos auf der Startseite.',
  ...
  uk: {
    registerFree:'Почати безкоштовно', heroKicker:'LUXURY ЗНАЙОМСТВА ДЛЯ СЕРЙОЗНИХ СТОСУНКІВ У ЄВРОПІ',
    heroConversionTitle:'Справжні люди. Взаємний вибір. Реальна зустріч.',
    heroConversionLead:'DUONERA — приватний мобільний клуб. Анкети з’являються лише за згодою та після перевірки. Ви обираєте людину, а не нескінченний каталог.',
    ...
    footerConversionTag:'Справжні люди. Взаємний вибір. Реальна зустріч.',
    productLabel:'DUONERA У ТЕЛЕФОНІ', productTitle:'Так само просто, як свайп. Набагато особистіше.', productText:'Після реєстрації ви бачите лише справжні схвалені анкети. Симпатія відкривається тільки при взаємному виборі. Жодних вигаданих фото на головній.',
  ...
  ru: {
    registerFree:'Начать бесплатно', heroKicker:'LUXURY ЗНАКОМСТВА ДЛЯ СЕРЬЁЗНЫХ ОТНОШЕНИЙ В ЕВРОПЕ',
    heroConversionTitle:'Настоящие люди. Взаимный выбор. Реальная встреча.',
    heroConversionLead:'DUONERA — закрытый мобильный клуб. Анкеты публикуются только с согласия и после проверки. Вы выбираете человека, а не бесконечный каталог.',
    ...
    footerConversionTag:'Настоящие люди. Взаимный выбор. Реальная встреча.',
    productLabel:'DUONERA В ТЕЛЕФОНЕ', productTitle:'Так же просто, как свайп. Намного личнее.', productText:'После регистрации вы увидите только реальные одобренные анкеты. Симпатия откроется лишь при взаимном выборе. Никаких выдуманных фото на главной.',
