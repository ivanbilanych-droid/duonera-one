import { createUuid, insertRow } from './supabase-client.js?v=3';
...
if(shortRegistrationForm){
  ...
  shortRegistrationForm.addEventListener('submit', async event => {
    ...
    const statusMessages = {
      ...
      de:{sending:'Registrierung wird gespeichert…',error:'Die Registrierung konnte nicht sicher gespeichert werden. Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.'}
    };
